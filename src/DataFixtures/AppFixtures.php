...
class AppFixtures extends Fixture
{
    ...
    private const TRICKS_INFOS = [
        ...
        [
            'title' => 'Mute',
            'description' => 'In this trick, when a player is in the air, he has to bend down on the board and grab the toe edge of the board between his two legs. He also has to grab the the middle edge of the board using his front hand at that moment.',
            'photos' => ['1.jpg', '2.jpg', '3.jpg'],
            'videos' => ['https://www.youtube.com/embed/jm19nEvmZgM', 'https://www.youtube.com/embed/k6aOWf0LDcQ']
        ],
        [
            'title' => 'sad',
            'description' => 'Quite similar to a nosebone but you grab with the front hand and on the heelside while the nose of the board points towards the ground.',
            'photos' => ['4.jpg'],
            'videos' => ['https://www.youtube.com/embed/KEdFwJ4SWq4']
        ],
        [
            'title' => 'indy',
            'description' => 'An Indy grab, also known as an Indy air, is an aerial skateboarding, snowboarding and kitesurfing trick during which the rider grabs their back hand on the middle of their board, between their feet, on the side of the board where their toes are pointing, while turning backside.',
            'photos' => ['5.png', '6.jpg', '7.jpg'],
            'videos' => ['https://www.youtube.com/embed/iKkhKekZNQ8']
        ],
        // Rotation
        [
            'title' => '180',
            'description' => 'A 180 is essentially spinning your snowboard, in the air, 180 degrees. You will start out facing one way down the mountain and end up facing the other way. Before learning how to do a 180 you should already be comfortable with ollies and with riding switch.',
            'photos' => ['8.jpg', '9.jpg'],
            'videos' => ['https://www.youtube.com/embed/ATMiAVTLsuc']
        ],
        [
            'title' => '360',
            'description' => 'A frontside 360 is when you leave the slope and rotate in the air 360 degrees before hitting the ground again.',
            'photos' => ['10.jpg', '11.jpg', '12.jpg'],
            'videos' => ['https://www.youtube.com/embed/JJy39dO_PPE']
        ],
        [
            'title' => '1080',
            'description' => 'A 1080 consists of three full rotations in the air.',
            'photos' => ['13.jpg', '14.png'],
        ...
        [
            'title' => 'rocket air',
            'description' => 'Achieved when rider takes both hands and grabs the nose of the snowboard. Rusty Trombone - Combination of a roast beef and nose grab done at the same time.',
            'photos' => ['17.jpg', '18.png'],
            'videos' => ['https://www.youtube.com/embed/nom7QBoGh5w']
        ],
        [
            'title' => 'Backside Air',
            'description' => 'A trick performed on the backside wall of the halfpipe where the athlete grabs the heel edge of the board with the front hand. Backside Handplant: A maneuver where the rider places either both hands or the rear hand on the lip of the halfpipe and rotates 180 degrees in the backside direction.',
            'photos' => ['19.jpg', '20.png', '21.jpg'],
            'videos' => ['https://www.youtube.com/embed/_CN_yyEn78M']
        ],
        [
            'title' => 'Method Air',
            'description' => 'A trick where the boarder grabs the heel edge of the board with their front hand, between their feet, and then pulls the board towards their back, while arching their back and bending knees.',
            'photos' => ['22.png', '23.png', '24.jpg'],
